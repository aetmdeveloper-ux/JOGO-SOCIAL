...
// ===== CÂMERA SEGUE PLAYER =====
cameraX = G.player.x - CFG.CANVAS_W / 2;
cameraY = G.player.y - CFG.CANVAS_H / 2;
// =============================================
// FIX DE CÂMERA AUTOMÁTICO (COLAR NO FINAL)
// =============================================

// Atualiza câmera automaticamente baseada no player
...
// Hook no render (sem quebrar seu código original)
...
render = function() {
  ...
  // Atualiza posição da câmera antes de desenhar
  updateCamera();
